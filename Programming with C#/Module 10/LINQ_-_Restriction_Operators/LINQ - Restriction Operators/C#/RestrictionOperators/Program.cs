    ...
    class Program
    {
        ...
        public class LinqSamples
        {
            ...
            public void Linq3()
            {
                ...
                var expensiveInStockProducts = from prod in products where prod.UnitPrice > 3 select prod;
            ...
            public void Linq4()
            {
                ...
                var waCustomers = from custom in customers where custom.Region == "WA" select custom;
